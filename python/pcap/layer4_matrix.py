...
def print_comparison_table(results: dict) -> None:
    ...
    rows = [
        ...
        ("Step 3 Build (s)",
            fmt_float(conv.ns_to_s(results["string"].step3_build_ns)),
            fmt_float(conv.ns_to_s(results["binary"].step3_build_ns))),
        ("Step 4 Save (s)",
            fmt_float(conv.ns_to_s(results["string"].step4_save_ns)),
            fmt_float(conv.ns_to_s(results["binary"].step4_save_ns))),
        ("Total Time (s)",
