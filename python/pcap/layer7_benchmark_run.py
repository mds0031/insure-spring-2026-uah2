...
def print_comparison_table(results):
    ...
    rows = [
        ...
        ("Step 4 Build (s)", fmt_float(ns_to_s(results["string"].step4_build_ns)), fmt_float(ns_to_s(results["binary"].step4_build_ns))),
        ("Step 5 Save (s)", fmt_float(ns_to_s(results["string"].step5_save_ns)), fmt_float(ns_to_s(results["binary"].step5_save_ns))),
